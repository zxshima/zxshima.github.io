ServerEvents.recipes(event => {
    ...
    event.remove({ output: 'twigs:cobblestone_bricks_slab' })
    event.remove({ output: 'twigs:cobblestone_bricks_wall' })
    event.remove({ output: 'twigs:cobblestone_bricks_stairs' })
    event.remove({ output: 'twigs:cracked_cobblestone_bricks' })
    event.remove({ output: 'caverns_and_chasms:mossy_cobblestone_brick_stairs' })
    event.remove({ output: 'twigs:mossy_cobblestone_bricks' })
    event.remove({ output: 'twigs:mossy_cobblestone_bricks_slab' })
    event.remove({ output: 'twigs:mossy_cobblestone_bricks_wall' })
    event.remove({ output: 'twigs:mossy_cobblestone_bricks_stairs' })
    ...
    event.remove({ output: 'infinity_buttons:cherry_bookshelf_secret_button' })
